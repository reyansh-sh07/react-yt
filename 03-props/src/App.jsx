...
const App = () => {
  return (
    ...
    <div className='HloooKIt'>
      <Card2 user = "Brook" data = "Loremnlfjanlejfa klfjaklflanj"  img = 'https://images.unsplash.com/photo-1751097006268-ae4601fcb117?q=80&w=1518&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' />
